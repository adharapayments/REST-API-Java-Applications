...
public class Example9 {
	...
	public static void main(String[] args) throws IOException, InterruptedException, DecoderException, KeyManagementException, CertificateException, NoSuchAlgorithmException, KeyStoreException{
		...
		List<AdharaHFT.orderTick> orderTickList1 = wrapper.getOrder(null, null, Arrays.asList(AdharaHFT.ORDERTYPE_PENDING));
		...
		List<AdharaHFT.orderTick> orderTickList2 = wrapper.getOrder(null, null, Arrays.asList(AdharaHFT.ORDERTYPE_PENDING));
		...
		List<AdharaHFT.modifyTick> modifyList = wrapper.modifyOrder(Arrays.asList(ordermod));
		for (AdharaHFT.modifyTick modifyresponse : modifyList){
		...
		List<AdharaHFT.orderTick> orderTickList3 = wrapper.getOrder(null, null, Arrays.asList(AdharaHFT.ORDERTYPE_PENDING));
